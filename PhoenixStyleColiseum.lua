...
function psfColiseum()
    ...
    if psanubheal == nil then
        psanubheal = {
            "", "", "DBM-healerA", "DBM-healerB", "DBM-healerC", "DBM-healerD",
            "DBM-healerE", ""
        }
    end
...
function PSFcoli_OnUpdate()
    ...
    if psshieldon == 1 and twvalboss1 == nil then
        ...
        if psschitupal == 1 then
            ...
            -- рисунок1
            psvelcastbar:SetWidth(psvalkastitsa *
                                      (PScolishieldmini:GetWidth() - 8) / 15)
            ...
            if psdamagvalkyes == 0 then
                ...
                psvelshieldbar:SetWidth(psdamagvalkyes *
                                            (PScolishieldmini:GetWidth() - 8) /
                                            psshieldamount)
            end
        ...
        if psvelcastbar:GetWidth() >
            ((PScolishieldmini:GetWidth() - 8) + PScolishieldmini:GetWidth() *
                0.1) then
            psshieldon = 0
    ...
    if psjxshieldon == 1 then
        ...
        if (psgalochki[1] == "yes") then
            if math.ceil(psvalostalos) == psvalostalos then
                tdamsh2:SetText(psvalostalos .. ".0 / " .. psjxshieldtime ..
                                    ".0")
            else
        ...
        -- рисунок1
        psvelcastbar:SetWidth(
            psvalkastitsa * (PScolishieldmini:GetWidth() - 8) / psjxshieldtime)
            ...
            if pstwtimeswitch[i] == "--" then
                if UnitName(pstwraidroster[i] .. "-target") == psvalbitnada then
                    if twinspart4 then
                        ...
                        -- считаем время
                        local psswichspeed =
                            math.ceil((GetTime() - psvaltimebcastGT) * 10) / 10
                        pstwtimeswitch[i] = psswichspeed
                    end
                end
            end
    ...
    if psshieldon == 1 and pstwtimenow > pscolnexttargcheck0 and
        psvaltimebcastGT > pstwtimenow - 3.5 then
    ...
    if GetNumRaidMembers() > 0 and event == "COMBAT_LOG_EVENT_UNFILTERED" then
        ...
        if (twinboyinterr == 1) then
            if (timetocheck == 0) then
                timetocheck = arg1 + 5
            elseif (arg7 == pscotwinsvalkyr or arg7 == pscotwinsvalkyr2) then
                timetocheck = arg1 + 5
        ...
        if (twinspart) then
            ...
            if (arg12 == 67303 or arg12 == 65875 or arg12 == 65876 or arg12 ==
                ...
                if arg2 == "SPELL_INTERRUPT" and psshieldon == 1 then
                    ...
                    if pstttest == 0 then
                        ...
                        if (twinspart3) then
                            pszapuskanonsa(wherereporttwins,
                                           "{rt1}" .. arg4 .. " " ..
                                               pscoltwinshield1 .. " " ..
                                               psvalskokaostalos .. " " ..
                                               pscoltwinshield2)
            ...
            if (arg9 == 67303 or arg9 == 65875 or arg9 == 65876 or arg9 == 67304 or
                ...
                if arg2 == "SPELL_CAST_START" then
                    ...
                    if (psdamagevalue == nil or psdamagevalue == {}) then
                        psdamagevalue = {}
                    end
                    if (psdamageraz == nil or psdamageraz == {}) then
                        psdamageraz = {}
                    end
                    if (psdamagename2 == nil or psdamagename2 == {}) then
                        psdamagename2 = {}
                    end
            ...
            if (psshieldon == 1 and arg7 == psnoobibiyut) then
                if arg1 > psvaltimebegincast + 1.8 then
                    if arg2 == "SPELL_DAMAGE" then
                        if arg9 == 58735 or arg9 == 10444 or arg9 == 1680 or
                            arg9 == 44949 or arg9 == 55262 or arg9 == 25504 or
                            arg9 == 57975 or arg9 == 47520 or arg9 == 55362 or
                            arg9 == 57965 or arg9 == 51690 or arg9 == 53190 or
                            arg9 == 48480 or arg9 == 50590 then
                        else
                            if arg12 == nil then
                            else
                                psunitisplayer(arg3, arg4)
        ...
        if jaraxpart then
            ...
            -- считаем хил
            if (arg7 == psvalbitnada and
                (psjxshieldon == 1 or psjxpausareport2 == 1)) then
            ...
            if psjxpausareport2 == 1 then
                ...
                if arg2 == "SPELL_AURA_APPLIED" and
                    ...
                    -- РЕПОРТ ФЕЙЛА
                    if (jaraxpart) then
                        pszapuskanonsa(wherereportjarax,
                                       "{rt8}" .. pscoljaraloc1 .. " " ..
                                           psvalbitnada .. " " ..
                                           pscolwasnthealed .. "!")
                    end
                ...
                if arg1 > psjxpausareport then
                    ...
                    if (thisaddononoff and jaraxpart2 and jaraxpart) then
                        ...
                        strochkadamageout =
                            "{rt2}" .. pscoljaraloc2 .. " (" .. psvalbitnada ..
                                ") " .. pscolhealili2 .. ": "
...
function PSFizmcoli1()
    if (PSFmain7_CheckButton201:GetChecked()) then
        twinspart = true
        pscolbosstxt2:SetText("|cff00ff00" .. pscoliboss1 .. "|r")
    else
        twinspart = false
        pscolbosstxt2:SetText("|cffff0000" .. pscoliboss1 .. "|r")
    end
...
function PSFizmcoli2()
    if (PSFmain7_CheckButton202:GetChecked()) then
        zveripart = true
        pscolbosstxt1:SetText("|cff00ff00" .. pscoliboss2 .. "|r")
    else
        zveripart = false
        pscolbosstxt1:SetText("|cffff0000" .. pscoliboss2 .. "|r")
    end
...
function PSFizmcoli3()
    if (PSFmain7_CheckButton203:GetChecked()) then
        jaraxpart = true
        pscolbosstxt3:SetText("|cff00ff00" .. pscoliboss3 .. "|r")
    else
        jaraxpart = false
        pscolbosstxt3:SetText("|cffff0000" .. pscoliboss3 .. "|r")
    end
...
function openmenutwins()
    if not DropDownMenuTwins then
        CreateFrame("Frame", "DropDownMenuTwins", PSFmain7,
...
function openmenujarax()
    if not DropDownMenujarax then
        CreateFrame("Frame", "DropDownMenujarax", PSFmain7,
                    "UIDropDownMenuTemplate")
    end
    pscreatedropmcol(DropDownMenujarax, "TOPLEFT", 130, -179, wherereportjarax,
                     2)
end

function openmenuzveri()
    if not DropDownMenuzveri then
        CreateFrame("Frame", "DropDownMenuzveri", PSFmain7,
                    "UIDropDownMenuTemplate")
    end
...
function PSF_colshieldmini()
    ...
    if (psfcolishieldspamno == nil) then
        ...
        tdamsh:SetWidth(120)
        tdamsh:SetHeight(15)
        if (psgalochki[2] == "yes") then tdamsh:SetText(pscolshield) end
        ...
        if (psgalochki[1] == "yes") then tdamsh2:SetText(pscolcast11) end
        ...
        if (psgalochki[3] == "yes") then tdamsh3:SetText(pscolnick) end
...
function pschangewidth()
    ...
    if psgalochki[1] == "no" then
        tdamsh2:SetText("")
    else
        tdamsh2:SetText(pscolcast11)
    end
    if psgalochki[2] == "no" then
        tdamsh:SetText("")
    else
        tdamsh:SetText(pscolshield)
    end
    if psgalochki[3] == "no" then
        tdamsh3:SetText("")
    else
    ...
    if psshieldon == 0 and psjxshieldon == 0 then
        psvelcastbar:SetWidth((PScolishieldmini:GetWidth() - 8) -
                                  PScolishieldmini:GetWidth() * 0.3)
        psvelshieldbar:SetWidth(PScolishieldmini:GetWidth() - 8)
    end
...
function PSTVgalka(nomersmeni)
    if psgalochki[nomersmeni] == "yes" then
        psgalochki[nomersmeni] = "no"
    else
        psgalochki[nomersmeni] = "yes"
    end
...
function pstwrelookmenu()
    ...
    if PSTwinValmenu_CheckButton1:GetChecked() == nil and
        PSTwinValmenu_CheckButton2:GetChecked() == nil and
        PSTwinValmenu_CheckButton3:GetChecked() == nil then
        pstwdamsh3:SetText(
            "(" .. pstwbetween .. " |cff00ff0030|r " .. pstwand .. " 999)")
        pstwdamsh4:SetText(
            "(" .. pstwbetween .. " |cff00ff0030|r " .. pstwand .. " 999)")
    elseif PSTwinValmenu_CheckButton1:GetChecked() == nil and
        PSTwinValmenu_CheckButton2:GetChecked() == nil then
        pstwdamsh3:SetText(
            "(" .. pstwbetween .. " |cff00ff00110|r " .. pstwand .. " 999)")
        pstwdamsh4:SetText(
            "(" .. pstwbetween .. " |cff00ff0050|r " .. pstwand .. " 999)")
    ...
    elseif PSTwinValmenu_CheckButton3:GetChecked() == nil then
        pstwdamsh3:SetText(
            "(" .. pstwbetween .. " |cffff0000150|r " .. pstwand .. " 999)")
        pstwdamsh4:SetText(
            "(" .. pstwbetween .. " |cff00ff0050|r " .. pstwand .. " 999)")
        ...
        pstwdamsh3:SetText(
            "(" .. pstwbetween .. " |cffff0000150|r " .. pstwand .. " 999)")
        pstwdamsh4:SetText(
            "(" .. pstwbetween .. " |cffff000080|r " .. pstwand .. " 999)")
        if pswelwidth < 150 then pswelwidth = 150 end
        if pswelheight < 80 then pswelheight = 80 end
    end
...
function PSTwinValApply()
    ...
    psvelcastbar:Show()
    psvelshieldbar:Show()
    if PSTwinValmenu_width1:GetNumber() > 29 and
        PSTwinValmenu_width1:GetNumber() < 1000 then
        pswelwidth = PSTwinValmenu_width1:GetNumber()
    end
    if PSTwinValmenu_heigh1:GetNumber() > 29 and
        PSTwinValmenu_heigh1:GetNumber() < 1000 then
        pswelheight = PSTwinValmenu_heigh1:GetNumber()
    end
    pstwrelookmenu()
    pschangewidth()
...
function psstavtochku(psstinga)
    ...
    if string.len(psstinga) > 6 then
        psstinga2 = string.sub(psstinga, 1, 1) .. "." ..
                        string.sub(psstinga, 2, 4) .. "." ..
                        string.sub(psstinga, 5)
    elseif string.len(psstinga) > 3 then
        psstinga2 = string.sub(psstinga, 1, string.len(psstinga) - 3) .. "." ..
                        string.sub(psstinga, string.len(psstinga) - 2)
    else
        psstinga2 = psstinga
    end
...
function psvaladdability(nrabil)
    ...
    if (bililine == 0) then
        if GetTime() > psvaltimetableadd then
            ...
            if #psvaltable == 3 then psvalcheckandrep() end

            if #psvaltable == 4 then table.wipe(psvaltable) end
        end
    end
end
...
function psvalcheckandrep()
    ...
    if psvaltable[1] == 2 then
        psvalannouncenextabsh = "{rt6} " .. pscolvalnxtabloc1 .. " - " ..
                                    pscolvalnxtabloc2 .. "! " ..
                                    pscolvalbeprepare .. " >>" ..
                                    pscotwinsvalkyr2 .. "<<"
...
function psfcoldraw()
    if psfcoldraw1 == nil then
        ...
        -- после боя
        local pstabtodraw2 = {
            psulonlyattheendsharof, psulonlyattheendval2, pscolvalsmena,
            psulrepjara
        }
        local p = -88
        for i = 1, 4 do
...
function pstwsozdtabltime(psboss)
    ...
    if (pstwtimeswitch == nil or pstwtimeswitch == {}) then
        pstwtimeswitch = {}
    end
    table.wipe(pstwraidroster)
    table.wipe(pstwtimeswitch)
