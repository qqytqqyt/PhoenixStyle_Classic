...
function psfcoltwinsinfoout(psout1, psout2, psout3)
    ...
    -- обнуление таблиц
    if (psstrochkainfoshield1 == nil or psstrochkainfoshield1 == {}) then
        psstrochkainfoshield1 = {}
    end
    if (psstrochkainfoshield2 == nil or psstrochkainfoshield2 == {}) then
        psstrochkainfoshield2 = {}
    end
    if (psstrochkainfoshield3 == nil or psstrochkainfoshield3 == {}) then
        psstrochkainfoshield3 = {}
    end
    if (psstrochkainfoshield4 == nil or psstrochkainfoshield4 == {}) then
        psstrochkainfoshield4 = {}
    end
    if (psnikividelyat == nil or psnikividelyat == {}) then
        psnikividelyat = {}
    end
    ...
    if psshieldinfostrochka > 4 then
    else

        if psout1 == 1 then
            psstrochkainfoshield1[psshieldinfostrochka] = pscolvalinfloc1 ..
                                                              " #" ..
                                                              psshieldinfostrochka ..
                                                              " - " ..
                                                              psvalbitnada ..
                                                              ". " ..
                                                              pscolvalinfloc2 ..
            ...
            if psshieldinfostrochka == 1 then
                tshinfo11:SetText("|CFFFFFF00" .. pscolvalinfloc4 .. " #1 - " ..
                                      psvalbitnada .. ". " .. pscolvalinfloc2 ..
                                      " " .. psout3 .. " " .. pscolvalinfloc3 ..
                                      " (" .. psout2 .. ")|r")
            elseif psshieldinfostrochka == 2 then
                tshinfo21:SetText("|CFFFFFF00" .. pscolvalinfloc4 .. " #2 - " ..
                                      psvalbitnada .. ". " .. pscolvalinfloc2 ..
                                      " " .. psout3 .. " " .. pscolvalinfloc3 ..
                                      " (" .. psout2 .. ")|r")
            elseif psshieldinfostrochka == 3 then
                tshinfo31:SetText("|CFFFFFF00" .. pscolvalinfloc4 .. " #3 - " ..
                                      psvalbitnada .. ". " .. pscolvalinfloc2 ..
                                      " " .. psout3 .. " " .. pscolvalinfloc3 ..
                                      " (" .. psout2 .. ")|r")
            elseif psshieldinfostrochka == 4 then
                tshinfo41:SetText("|CFFFFFF00" .. pscolvalinfloc4 .. " #4 - " ..
                                      psvalbitnada .. ". " .. pscolvalinfloc2 ..
                                      " " .. psout3 .. " " .. pscolvalinfloc3 ..
                                      " (" .. psout2 .. ")|r")
            end
            ...
            if psshieldinfostrochka == 1 then
                tshinfo11:SetText("|CFFFFFF00" .. pscolvalinfloc4 .. " #1 - " ..
                                      psvalbitnada .. ". |cffff0000" ..
                                      pscolvalinfloc5 .. "|r - " .. psout2 ..
                                      " " .. psulhp .. ".|r")
            elseif psshieldinfostrochka == 2 then
                tshinfo21:SetText("|CFFFFFF00" .. pscolvalinfloc4 .. " #2 - " ..
                                      psvalbitnada .. ". |cffff0000" ..
        ...
        if (vzxnn > 0) then
            ...
            for i = 1, vzxnn do
                ...
                if i == vzxnn then
                    psinfoshieldtemp = psinfoshieldtemp .. psdamagename[i] ..
                                           " (" .. psinfoshieldtempdamage ..
                                           " - " .. psdamageraz[i] .. ")" ..
                                           pstochki
                else
        ...
        if psshieldamount == 1200000 then
            psnormdpsshield = 80000
        elseif psshieldamount == 700000 then
            psnormdpsshield = 40000
        elseif psshieldamount == 300000 then
            psnormdpsshield = 50000
        else
            psnormdpsshield = 30000
        end
        local psinfoshieldtemp = ""
        ...
        if (vzxnn > 0) then
            for i = 1, vzxnn do
                ...
                for j = 1, #pstwraidroster do
                    if pstwraidroster[j] == psdamagename2[i] then
                        pstemptimeswich = pstwtimeswitch[j]
                    end
                end
                ...
                if i == vzxnn then
                    ...
                    if string.len(psinfoshieldtemp) < 125 then
                        psinfoshieldtemp =
                            psinfoshieldtemp .. psdamagename2[i] .. " (" ..
                                psinfoshieldtempdamage .. " - " ..
                                pstemptimeswich .. "s). "
                    else
                        psinfoshieldtemp2 =
                            psinfoshieldtemp2 .. psdamagename2[i] .. " (" ..
                                psinfoshieldtempdamage .. " - " ..
                                pstemptimeswich .. "s). "
                    end

                    if psdamagevalue2[i] >= psnormdpsshield then
                        psinfoshieldtempframe =
                            psinfoshieldtempframe .. "|cff00ff00" ..
                                psdamagename2[i] .. "|r (" ..
                                psinfoshieldtempdamage .. " - " ..
                                pstemptimeswich .. "s). "
                    else
                        psinfoshieldtempframe =
                            psinfoshieldtempframe .. "|cffff0000" ..
                                psdamagename2[i] .. "|r (" ..
                                psinfoshieldtempdamage .. " - " ..
                                pstemptimeswich .. "s). "
                    end
        ...
        if psshieldinfostrochka == 1 then
            ...
            tshinfo12:SetText("|cffff0000" .. pscolvalinfloc6 .. ":|r " ..
                                  psstrochkainfoshield2[1])
            tshinfo13:SetText("|CFFFFFF00" .. pstxtbegin .. "|r" ..
                                  psinfoshieldtempframe)
        elseif psshieldinfostrochka == 2 then
            PSFmainshieldinfo_Buttonsend2:Show()
            tshinfo22:SetText("|cffff0000" .. pscolvalinfloc6 .. ":|r " ..
                                  psstrochkainfoshield2[2])
            tshinfo23:SetText("|CFFFFFF00" .. pstxtbegin .. "|r" ..
                                  psinfoshieldtempframe)
        elseif psshieldinfostrochka == 3 then
            PSFmainshieldinfo_Buttonsend3:Show()
            tshinfo32:SetText("|cffff0000" .. pscolvalinfloc6 .. ":|r " ..
                                  psstrochkainfoshield2[3])
            tshinfo33:SetText("|CFFFFFF00" .. pstxtbegin .. "|r" ..
                                  psinfoshieldtempframe)
        elseif psshieldinfostrochka == 4 then
            PSFmainshieldinfo_Buttonsend4:Show()
            tshinfo42:SetText("|cffff0000" .. pscolvalinfloc6 .. ":|r " ..
                                  psstrochkainfoshield2[4])
            tshinfo43:SetText("|CFFFFFF00" .. pstxtbegin .. "|r" ..
                                  psinfoshieldtempframe)
        end
...
function openmenureportinfoshield()
    if not DropDownMenureportinfoshield then
        CreateFrame("Frame", "DropDownMenureportinfoshield", PSFmainshieldinfo,
                    "UIDropDownMenuTemplate")
    end
    pscreatedropmcol(DropDownMenureportinfoshield, "BOTTOMLEFT", 198, 7,
                     wherereportinfshield, 4)
end

function openpodsvetkavalkyr()
    if not DropDownMenupodsvetkavalkyr then
        CreateFrame("Frame", "DropDownMenupodsvetkavalkyr", PSFmainshieldinfo,
                    "UIDropDownMenuTemplate")
    end
...
function PSF_colshieldinfsend(nmknopki)
    ...
    psfchatsendreports(wherereportinfshield, psstrochkainfoshield1[nmknopki],
                       "{rt7} " .. pscolvalinfloc6 .. ": " ..
                           psstrochkainfoshield2[nmknopki], "{rt2} " ..
                           pstxtbegin .. psstrochkainfoshield3[nmknopki],
                       psstrochkainfoshield4[nmknopki])
...
function psaddnickvidelenie(nicktoadd)
    ...
    for i, getcrash in ipairs(psnikividelyat) do
        if getcrash == nicktoadd then bililine = 1 end
    end
    if (bililine == 0) then
...
function psblustring1(stringa, vibor)
    ...
    if striniz == nil then
        ...
        psblunovastringa =
            string.sub(stringa, 1, striniz - 1) .. "|CFF000FFF" ..
                string.sub(stringa, striniz, strfine - 1) .. "|r" ..
                string.sub(stringa, strfine)
...
function psblustring2(stringa, vibor)
    ...
    if striniz == nil then
        ...
        psblunovastringa =
            string.sub(stringa, 1, striniz - 11) .. "|CFF000FFF" ..
                string.sub(stringa, striniz)
...
function psbluoffstring1(stringa)
    ...
    if striniz == nil then
        ...
        psblunovastringa = string.sub(stringa, 1, striniz - 1) ..
                               string.sub(stringa, strfine + 1, striniz2 - 1) ..
                               string.sub(stringa, strfine2 + 1)
...
function psbluoffstring2(stringa)
    ...
    if striniz == nil then
        ...
        if string.find(stringa, "k", strfine2 + 2) == nil then
            ...
            psblunovastringa = string.sub(stringa, 1, striniz - 1) ..
                                   "|cffff0000" ..
                                   string.sub(stringa, strfine + 1)
        else

            if string.find(stringa, "k", strfine2 + 2) >
                string.find(stringa, " ", strfine2 + 2) then
                psblunovastringa = string.sub(stringa, 1, striniz - 1) ..
                                       "|cffff0000" ..
                                       string.sub(stringa, strfine + 1)
                -- красный
                ...
                if tonumber(string.sub(stringa, strfine2 + 3, striniz3 - 1)) *
                    1000 >= psnormdpsshield then
                    -- зеленый
                    psblunovastringa = string.sub(stringa, 1, striniz - 1) ..
                                           "|cff00ff00" ..
                                           string.sub(stringa, strfine + 1)
        ...
        for i = 1, vzxnn do
            ...
            if i == vzxnn then
                if (string.len(strochkadamageout) > 220 and qq == nil) then
                    strochkavezcrash2 = strochkavezcrash2 .. psdamagename2[i] ..
                                            " (" .. psinfoshieldtempdamage ..
                                            " - " .. pstemptimeswich .. "s)" ..
                                            pstochki
                else
                    strochkadamageout = strochkadamageout .. psdamagename2[i] ..
                                            " (" .. psinfoshieldtempdamage ..
                                            " - " .. pstemptimeswich .. "s)" ..
                                            pstochki
                end
                ...
                if (string.len(strochkavezcrash2) > 3 and qq == nil) then
                    pszapuskanonsa(inwhichchat, strochkavezcrash2)
                end
            else
                if (string.len(strochkadamageout) > 220 and qq == nil) then
                    strochkavezcrash2 = strochkavezcrash2 .. psdamagename2[i] ..
