...
function psfxtafterf()
    if (thisaddononoff and bosspartul[6] == 1) then
        ...
        reportafterboitwotab(whererepbossulda[6], true, vezaxname, vezaxcrash,
                             1, 10)
        strochkavezcrash = "{rt1}" .. psulxttext2
        reportafterboitwotab(whererepbossulda[6], true, vezaxname2, vezaxcrash2,
                             1, 10)
        strochkavezcrash = "{rt8}" .. psulxttext3
        reportafterboitwotab(whererepbossulda[6], true, vezaxname3, vezaxcrash3,
                             1, 10)
    end
