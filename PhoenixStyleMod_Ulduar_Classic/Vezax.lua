...
function psfvezaxreportheal()
    if (thisaddononoff and bosspartul[1] == 1 and bosspartul2[1] == 1) then
        ...
        pszapuskanonsa(whererepbossulda[1],
                       "{rt7}" .. metkaonwho .. " " .. psulvezax2 .. " " ..
                           psveztempheal .. " " .. psulhp .. ". " ..
                           wasdebuffgena .. "")
    end
    ...
    if (sumheal > topvezaxheal3) then
        ...
        if (wasdebufgena) then
            topvezaxdeb3 = psulvezax3
        else
            topvezaxdeb3 = ""
        end
    ...
    if arg4 == psulgeneralvezax then
        ...
        if psunitplayertrue then
            ...
            if (bosspartul[1] == 1 and bosspartul2[1] == 1) then
                spelllink = "\124cff71d5ff\124Hspell:" .. arg9 .. "\124h[" ..
                                arg10 .. "]\124h\124r"
                pszapuskanonsa(whererepbossulda[1],
                               "{rt8}" .. arg7 .. " " .. psulvezax4 .. " " ..
                                   spelllink .. " > " .. arg12 .. " " .. psulhp ..
                                   ".")
            end
        end
    end
...
function psfvezaxafterf()
    if (thisaddononoff and bosspartul[1] == 1) then
        if (topvezaxheal1 > 0) then
            ...
            pszapuskanonsa(whererepbossulda[1],
                           "1. " .. topvezaxname1 .. " - " .. psveztempheal ..
                               " " .. psulhp .. ". " .. topvezaxdeb1 .. "", true)

            if (topvezaxheal2 > 0) then
                vezaxobrezanie(topvezaxheal2)

                pszapuskanonsa(whererepbossulda[1],
                               "2. " .. topvezaxname2 .. " - " .. psveztempheal ..
                                   " " .. psulhp .. ". " .. topvezaxdeb2 .. "",
                               true)
...
function vezaxobrezanie(chtoobrez)
    ...
    if string.len(pshealstring) > 3 then
        psveztempheal =
            string.sub(pshealstring, 1, string.len(pshealstring) - 3)
        psveztempheal = psveztempheal .. "k"
    else
