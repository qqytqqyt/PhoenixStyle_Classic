...
function psfsovettimeaft()
    if (bosspartul[3] == 1) then
        if whodispeled1 == "0" then
            pszapuskanonsa(whererepbossulda[3],
                           "{rt7} '" .. psulsovetbuff .. "' " .. psulsovetfrom ..
                               " " .. fromwhodispeled .. " " .. psulsovetnotd ..
                               " " .. timerez1 .. " " .. pssec)
        else
            if (timerez1 > 1) then
                pszapuskanonsa(whererepbossulda[3],
                               "{rt8} " .. whodispeled1 .. " " .. psulsovetsnyal ..
                                   " '" .. psulsovetbuff .. "' " ..
                                   psulsovetfrom .. " " .. fromwhodispeled ..
                                   " " .. psulsovetin .. " " .. timerez1 .. " " ..
                                   pssec)
            else
                if (bosspartul2[2] == 1) then
                    pszapuskanonsa(whererepbossulda[3],
                                   "{rt6} " .. whodispeled1 .. " " ..
                                       psulsovetsnyal .. " '" .. psulsovetbuff ..
                                       "' " .. psulsovetfrom .. " " ..
                                       fromwhodispeled .. " " .. psulsovetin ..
                                       " " .. timerez1 .. " " .. pssec)
                end
            end
        end
