...
function pslocaleulduarui()
    ...
    psulthorim2 = "Thorim"
    psulbossinfo1 =
        "- show who gets Shadowcrashed and amount of boss healing from Mark of the Faceless."
    ...
    psulbossinfo6 =
        "- show some fails at the end of the fight + count Guadians needed to kill."
    ...
    psleviboterr2 =
        "This module can be turned ON only |cffff0000not in combat|r."
    psleviboterr3 =
        "You have no rights to use this module, ask Raid Leader to promote you."
    pslevibotwin = "Leviathan |cff00ff00defeated!|r Levi-bot is now disabled!"
    pslevibotwipe =
        "|cffff0000Wipe on Leviathan|r. Levi-bot is ready for next try. Good luck!"
    psullevibesure =
        "Be sure that module is good for your tactic! We use 2 landings, 3+3 flying people from 3 catapults with marks."
...
function pslocaleuldalevi()
    ...
    pslevirol1 =
        "you are siege engine driver, you ram lashers, interrupt boss cast (if RL doesn't give other priority)"
    pslevirol2 =
        "you are demolisher driver (without mark), you will have 1 passenger (do not throw him)."
    pslevirol3 =
        "you are siege engine passenger, kill lashers, force down pyrite."
    pslevirol4 = "you are demolisher driver with mark"
    pslevirol5 = "throw people from catapult, hold stack of pyrite on boss."
    pslevirol6 =
        "you are passenger of demolisher without mark, force down pyrite and reload it with it, help killing lashers."
