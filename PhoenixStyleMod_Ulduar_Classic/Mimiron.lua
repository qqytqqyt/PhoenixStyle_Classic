function psfmimidetectnoob(arg1, arg2, arg6, arg7)
    ...
    if arg2 == "SPELL_AURA_REMOVED" then SetRaidTarget(arg7, 0) end
end
...
function psfmimireportnoob()
    if (thisaddononoff and bosspartul[2] == 1) then
        ...
        elseif mimiskokanubov == 2 then
            ...
            pszapuskanonsa(whererepbossulda[2],
                           "{rt8}" .. psulnapalmgot .. " " .. mimiskokanubov ..
                               ": {rt7}" .. napalmnumnoobs[1] .. ", {rt1}" ..
                               napalmnumnoobs[2] .. ".")
        elseif mimiskokanubov > 2 then
            SetRaidTarget(napalmnumnoobs[1], 7)
            SetRaidTarget(napalmnumnoobs[2], 1)
            ...
            if napalmnumnoobs[4] == nil then
                mimispisokot4 = "."
                mimispisokot4 = mimispisokot4 ..
                                    table.concat(napalmnumnoobs, ", ", 4)
            end
            pszapuskanonsa(whererepbossulda[2],
                           "{rt8}" .. psulnapalmgot .. " " .. mimiskokanubov ..
                               ": {rt7}" .. napalmnumnoobs[1] .. ", {rt1}" ..
                               napalmnumnoobs[2] .. ", {rt2}" ..
                               napalmnumnoobs[3] .. mimispisokot4)
        end
    end
