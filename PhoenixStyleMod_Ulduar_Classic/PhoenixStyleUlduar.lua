...
function psfUlduar()
    ...
    if GetRealZoneText() == pszoneulduar then
        PhoenixStyleMod_Ulduar_Classic:RegisterEvent("COMBAT_LOG_EVENT_UNFILTERED")
    end
    PhoenixStyleMod_Ulduar_Classic:RegisterEvent("PLAYER_REGEN_DISABLED")
    PhoenixStyleMod_Ulduar_Classic:RegisterEvent("PLAYER_REGEN_ENABLED")
    PhoenixStyleMod_Ulduar_Classic:RegisterEvent("ZONE_CHANGED_NEW_AREA")
...
function psfUlduaronevent(self,event,...)
    ...
    if event == "ZONE_CHANGED_NEW_AREA" then
        ...
        if GetRealZoneText() == pszoneulduar then
            ...
            PhoenixStyleMod_Ulduar_Classic:UnregisterEvent("COMBAT_LOG_EVENT_UNFILTERED")
        end
    ...
    if GetNumGroupMembers() > 0 and event == "COMBAT_LOG_EVENT_UNFILTERED" then
        ...
        if (pslevibot and ifwaslevi == 0) then
            if (arg4 == psulleviafanchik or arg7 == psulleviafanchik) and
                (arg2 == "SPELL_CAST_SUCCESS" or arg2 == "SPELL_DAMAGE" or arg2 ==
                    "SPELL_PERIODIC_DAMAGE" or arg2 == "SPELL_MISSED") then
                ifwaslevi = 1
                PSF_getnamelevi()
                SendChatMessage(psullevitxt6 .. ": {rt4}" .. nick[7] ..
                                    ", {rt3}" .. nick[8] .. ", {rt1}" .. nick[9] ..
                                    " >>>" .. pslevidesgogo .. "<<<",
                                "raid_warning")
        ...
        if (leviboyinterr == 1) then
            if (timetocheck == 0) then
                timetocheck = arg1 + 5
            elseif (arg7 == psulleviafanchik or arg4 == psulleviafanchik) then
                timetocheck = arg1 + 5
        ...
        if (pslevibot and ifwaslevi == 1) then
            if arg9 == 62475 and arg2 == "SPELL_AURA_APPLIED" and arg7 ==
                psulleviafanchik then
                PSF_getnamelevi()
                SendChatMessage(
                    psulleviinfo11 .. " " .. nick[13] .. " {rt4} " .. psullevito ..
                        " {rt5}.   " .. nick[14] .. " {rt3} " .. psullevito ..
                        " {rt2}.   " .. nick[15] .. " {rt1} " .. psullevito ..
                        " {rt6}.", "raid")
        ...
        if (pslevibot and ifwaslevi == 1) then
            if arg9 == 62475 and arg2 == "SPELL_AURA_REMOVED" and arg7 ==
                psulleviafanchik then
                ...
                if (kakayavisadka == 1) then
                    SendChatMessage(psullevitxt6 .. ": {rt4}" .. nick[7] ..
                                        ", {rt3}" .. nick[8] .. ", {rt1}" ..
                                        nick[9] .. " >>>" .. pslevidesgogo ..
                                        "<<<", "raid_warning")
                    for i = 1, 3 do
                        if nick[i + 6] == " " then
                        else
                            SendChatMessage(
                                "PhoenixStyle > " .. pslevitimetodie, "WHISPER",
                                nil, nick[i + 6])
                        end
                    end
                elseif (kakayavisadka == 2) then
                    SendChatMessage(psullevitxt7 .. ": {rt4}" .. nick[10] ..
                                        ", {rt3}" .. nick[11] .. ", {rt1}" ..
                                        nick[12] .. " >>>" .. pslevidesgogo ..
                                        "<<<", "raid_warning")
                    for i = 1, 3 do
                        if nick[i + 9] == " " then
                        else
        ...
        if (pslevibot and ifwaslevi == 1 and arg2 == "UNIT_DIED" and arg7 ==
            psulleviafanchik) then
            psfleverezetwin()
            psflevimarksdown()
        end
        ...
        if (vezaxboyinterr == 1) then
            if (timetocheck == 0) then
                timetocheck = arg1 + 5
            elseif (arg7 == psulgeneralvezax or arg7 == psulsaronite) then
                timetocheck = arg1 + 5
            elseif (arg1 > timetocheck) then
                psfvezaxafterf()
                psfvezaxrezetall()
        ...
        if (xtboyinterr == 1) then
            if (timetocheck == 0) then
                timetocheck = arg1 + 5
            elseif (arg7 == psyoggfail1 or arg7 == psyoggfail2 or arg7 ==
                psyoggfail3 or arg4 == psyoggfail1 or arg4 == psyoggfail2 or
                arg4 == psyoggfail3) then
                timetocheck = arg1 + 8
            elseif (arg1 > timetocheck) then
                psfxtafterf()
                psfxtresetall()
        ...
        if (timealgaloncast > 0) then
            if (arg1 > timealgaloncast) then timealgaloncast = 0 end
        end
        ...
        if (wasornovezax == 1 and timehealvez > 0) then
            if (arg1 > timehealvez) then psfvezaxreportheal() end
        end
        ...
        if thisaddononoff and bosspartul[6] == 1 and bosspartul2[4] == 1 then
                ...
                if kolyoggaddov == 7 then
                    ...
                    if (whererepbossulda[6] == "sebe") then
                        ...
                        if ((UnitIsGroupAssistant("player") or UnitIsGroupLeader("player")) or psfnopromrep) then
                            if (whererepbossulda[6] == "raid" and
                                (UnitIsGroupAssistant("player") or UnitIsGroupLeader("player"))) then
                                if psanonceinst then
                                    SendChatMessage(
                                        psulyoggguard1 .. " " ..
                                            (8 - kolyoggaddov), "raid_warning")
                                end
                            else
                                if psanonceinst then
                                    psyogginstango(
                    ...
                    if (whererepbossulda[6] == "sebe") then
                        ...
                        if ((UnitIsGroupAssistant("player") or UnitIsGroupLeader("player")) or psfnopromrep) then
                            if (whererepbossulda[6] == "raid" and
                                (UnitIsGroupAssistant("player") or UnitIsGroupLeader("player"))) then
                                if psanonceinst then
                                    SendChatMessage(psulyoggguard2,
                                                    "raid_warning")
                                end
                            else
                                if psanonceinst then
            ...
            if psyoggstrajtime == 1 then
                ...
                if arg2 == "SPELL_DAMAGE" and arg9 == 65719 and arg7 ==
...
function openmenugeneral()
    if not DropDownMenuGeneral then
        CreateFrame("Frame", "DropDownMenuGeneral", PSFmain6,
...
function openmenumimiron()
    if not DropDownMenuMimiron then
        CreateFrame("Frame", "DropDownMenuMimiron", PSFmain6,
                    "UIDropDownMenuTemplate")
    end
...
function openmenustal()
    if not DropDownMenuStal then
        CreateFrame("Frame", "DropDownMenuStal", PSFmain6,
                    "UIDropDownMenuTemplate")
    end
...
function openmenuhodir()
    if not DropDownMenuHodir then
        CreateFrame("Frame", "DropDownMenuHodir", PSFmain6,
                    "UIDropDownMenuTemplate")
    end
...
function openmenualg()
    if not DropDownMenuAlg then
        CreateFrame("Frame", "DropDownMenuAlg", PSFmain6,
                    "UIDropDownMenuTemplate")
    end
...
function openmenuxt()
    if not DropDownMenuxt then
        CreateFrame("Frame", "DropDownMenuxt", PSFmain6,
                    "UIDropDownMenuTemplate")
    end
...
function openmenutorim()
    if not DropDownMenutorim then
        CreateFrame("Frame", "DropDownMenutorim", PSFmain6,
                    "UIDropDownMenuTemplate")
    end
...
function psfuldraw()
    if psfuldraw1 == nil then
        ...
        local psfbosstemmp = {
            psulbosstxt1, psulbosstxt2, psulbosstxt3, psulbosstxt4,
            psulbosstxt5, psulbosstxt6, psulbosstxt7
        }
        for i = 1, 7 do psulcreatbosstxt(psfbosstemmp[i], i) end

        -- описание
        local pstabtodraw2 = {
            psulbossinfo1, psulbossinfo2, psulbossinfo3, psulbossinfo4,
            psulbossinfo5, psulbossinfo6, psulbossinfo7
        }
        for i = 1, 7 do
            local t = PSFmain6:CreateFontString()
            t:SetWidth(450)
        ...
        -- после боя
        local pstabtodraw2 = {
            psulonlyattheend, nil, psulonlyattheendstal, nil, psulonlyattheend,
            psulonlyattheendyogg1, psulonlyattheend
        }
        for i = 1, 7 do
        ...
        -- чекбатон1
        PSFmain6_CheckButton201 = CreateFrame("CheckButton", nil, PSFmain6,
                                              "UICheckButtonTemplate")
        PSFmain6_CheckButton202 = CreateFrame("CheckButton", nil, PSFmain6,
                                              "UICheckButtonTemplate")
        PSFmain6_CheckButton203 = CreateFrame("CheckButton", nil, PSFmain6,
                                              "UICheckButtonTemplate")
        PSFmain6_CheckButton204 = CreateFrame("CheckButton", nil, PSFmain6,
                                              "UICheckButtonTemplate")
        PSFmain6_CheckButton205 = CreateFrame("CheckButton", nil, PSFmain6,
                                              "UICheckButtonTemplate")
        PSFmain6_CheckButton206 = CreateFrame("CheckButton", nil, PSFmain6,
                                              "UICheckButtonTemplate")
        PSFmain6_CheckButton207 = CreateFrame("CheckButton", nil, PSFmain6,
                                              "UICheckButtonTemplate")
        local psulchbaton1 = {
            PSFmain6_CheckButton201, PSFmain6_CheckButton202,
            PSFmain6_CheckButton203, PSFmain6_CheckButton204,
            PSFmain6_CheckButton205, PSFmain6_CheckButton206,
            PSFmain6_CheckButton207
        }
        for i = 1, 7 do psulsozdcb1(psulchbaton1[i], 45, 16 - 49 * i, i) end
...
function psfcheckbossescolors()
    ...
    for i = 1, 7 do
        if (bosspartul[i] == 1) then
            psfzelkras[i][1]:SetChecked(true)
            psfzelkras[i][2]:SetText("|cff00ff00" .. psfzelkras[i][3] .. "|r")
        else
            psfzelkras[i][2]:SetText("|cffff0000" .. psfzelkras[i][3] .. "|r")
            psfzelkras[i][1]:SetChecked(false)
        end
    end
    if (bosspartul2[3] == 1) then
        PSFmain6_CheckButton215:SetChecked(false)
    else
        PSFmain6_CheckButton215:SetChecked(true)
    end
    if (bosspartul2[4] == 1) then
        PSFmain6_CheckButton216:SetChecked(false)
    else
        PSFmain6_CheckButton216:SetChecked(true)
    end
    if (bosspartul2[1] == 1) then
        PSFmain6_CheckButton211:SetChecked(false)
    else
        PSFmain6_CheckButton211:SetChecked(true)
    end
    if (bosspartul2[5] == 1) then
        PSFmain6_CheckButton217:SetChecked(false)
    else
        PSFmain6_CheckButton217:SetChecked(true)
    end
    if (bosspartul2[2] == 1) then
        PSFmain6_CheckButton213:SetChecked(false)
    else
        PSFmain6_CheckButton213:SetChecked(true)
    end
end
...
function psyogginstango(rep)
    ...
    for i, cc in ipairs(bigmenuchatlisten) do
        if cc == whererepbossulda[6] then bililine = 1 end
    end
