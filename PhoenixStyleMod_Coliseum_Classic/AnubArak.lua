...
function openmenuanub()
    if not DropDownMenuAnub then
        CreateFrame("Frame", "DropDownMenuAnub", PSFmainanub,
...
function openmenuanub2()
    if not DropDownMenuAnub2 then
        CreateFrame("Frame", "DropDownMenuAnub2", PSFmainanub,
                    "UIDropDownMenuTemplate")
    end
    pscreatedropmcol(DropDownMenuAnub2, "TOPLEFT", 377, -220, wherereportanub2,
                     6)
end
...
function PSF_colanubsend()
    ...
    for i = 1, 8 do
        if psanubheal[i] == "" then
            ...
            psfchatsendreports(wherereportanub,
                               "{rt" .. i .. "} " .. psanubheal[i])
...
function PSF_colanubsend2()
    ...
    psfchatsendreports(wherereportanub2, "{rt8} " .. pscolkiteanub,
                       "1: " .. psanubbop[1] .. " - " .. psanubbop[2],
                       "2: " .. psanubbop[3] .. " - " .. psanubbop[4])
    pscolclearfoc()
end
