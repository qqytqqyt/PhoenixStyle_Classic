...
function pslocalecoliseum()
    ...
    pscoltwinshield4 = "HP."
    pscoltwinshield5 =
        "Damage to another boss, no dots and aoe (damage - count): "
    pscolshield = "HP info"
    pscolkick = "kick!"
    pscolnick = "Nick"
    ...
    pscolvalchntxt1 =
        "Damage in shield and time lost to change target (considering debuff color OFF): "
    pscolvalchntxt2 =
        "Damage in shield and time lost to change target considering debuff: "
    pscolnewveranoncet = {
        "|cff00ff00Twin Val'kyr|r > if you install latest version of |cff00ff00TwinValkyr_shieldmonitor|r addon - you will target boss when click to 'HP-shield' frame!",
        "|cff00ff00Anub'arak|r > module added to save marks assignments for healers.",
        "|cff00ff00Twin Val'kyr|r > shows time taken to switch target, if raiders have to switch essence before changing target - |cff00ff00set this in options to control their debuff color!|r"
    }
...
function pslocalecoliseumui()
    ...
    pscoliinfoboss1 =
        "- show shieldmonitor frame, and report to chat, also report who got spheres."
    pscoliinfoboss2 = "- show who didn't run away from Icehowl's charge."
    pscoliinfoboss3 =
        "- show who healed Incinerate Flesh + heal-needed monitor frame."
    ...
    pscolfrmavalloc1 =
        "Information about damage to Valkyr's shields will be here."
    ...
    pscolanubtit2 =
        "This module doesn't mark Penetration Cold, it only save marks assignments. To mark players use 'DBM', 'Penetrator' or other similar addon. It's not suggested to have 2 different addons in a raid, can cause disappearing of marks."
    pscolanubmarkthem = "Mark them"
    pscolanubbut = "Anub'arak"
    pscoltwinvaladd =
        "If you want to take boss in target after clicking 'HP-shield' frame - install latest version of |cff00ff00TwinValkyr_shieldmonitor|r addon."
