...
if psf_getlocale() == "deDE" then
    ...
    function pslocalecoliseum()
        ...
        pscolvalchntxt1 =
            "Schaden auf Schild und bis zum Wechsel vergangene Zeit (Debuff AUS): "
        pscolvalchntxt2 =
            "Schaden auf Schild und bis zum Wechsel vergangene Zeit (Debuff AN): "
        pscolnewveranoncet = {
            "|cff00ff00Zwillingsval'kyr|r > wenn Sie die aktuelle Version vom AddOn |cff00ff00TwinValkyr_shieldmonitor|r haben, dann wird nach dem Klicken auf den Rahmen 'HP-Schild' - der Boss ausgew\195\164hlt.",
            "|cff00ff00Anub'arak|r > Das Modul f\195\188r das Speichern der Heilernamen und der Markierungen wurde hinzugef\195\188gt.",
            "|cff00ff00Zwillingsval'kyr|r > zeigt Zeit bis zum Wechsel an, wenn die Raider die Farbe wechseln m\195\188ssen - |cff00ff00setze diese Option ein!|r"
        }
    ...
    function pslocalecoliseumui()
        ...
        pscoliinfoboss1 =
            "- zeigt Schildmonitor und gibt es im Raid aus. Gibt auch die Kugelinfo an."
        pscoliinfoboss2 =
            "- zeigt, wer nicht Eisheulers Ansturm ausgewichen ist."
        pscoliinfoboss3 =
            "- zeigt an, wer Fleisch ein\195\164schern geheilt hat und den Monitor-Frame dazu."
        ...
        pscolanubtit2 =
            "Dieses Modul zeichnet selbst nicht die Heiler mit einer Schlachtzugsmarke aus, es merkt nur die Namen von den Heilern. Benutzen Sie solche Add-ons wie 'DBM', 'Penetrator' oder ein funktions\195\164hnliches AddOn, um die Schlachtzugsmarken zu setzen. Es wird dringend empfohlen nicht verschiedene AddOns in einem Schlachtzug zu benutzen, da dadurch die Schlachtzugsmarken ausgeschaltet werden k\195\182nnen."
        pscolanubmarkthem = "markieren"
        pscolanubbut = "Anub'arak"
        pscoltwinvaladd =
            "Wenn Sie m\195\182chten, dass bei dem Klicken auf den Rahmen der Boss als Ziel ausgew\195\164hlt wird, dann sollten Sie das AddOn |cff00ff00TwinValkyr_shieldmonitor|r herunterladen."
