        ...
        if classch then
            ...
            if #pstableid > 0 then
                ...
                if psiccschet3 <= 4 then
                    if #pstableid == 1 then
                        if UnitSex(pstablename[1]) and UnitSex(pstablename[1]) ==
                            3 then
                            if UnitSex(psnm) and UnitSex(psnm) == 3 then
                                psstringa =
                                    "{rt8} " .. psnm .. " " ..
                                        psiccfailtxt11511fem .. " 1 " ..
                                        psiccldfail261fem .. pstablename[1]
                            else
                                psstringa =
                                    "{rt8} " .. psnm .. " " .. psiccfailtxt11511 ..
                                        " 1 " .. psiccldfail261fem ..
                                        pstablename[1]
                            end
                        else
                            psstringa = "{rt8} " .. psnm .. " " ..
                                            psiccfailtxt11511 .. " 1 " ..
                                            psiccldfail261 .. pstablename[1]
                        end
                    else
                        if UnitSex(psnm) and UnitSex(psnm) == 3 then
                            psstringa = "{rt8} " .. psnm .. " " ..
                                            psiccfailtxt11511fem .. " " ..
                                            #pstableid .. " " .. psiccldfail262
                        else
                            psstringa = "{rt8} " .. psnm .. " " ..
                                            psiccfailtxt11511 .. " " ..
                                            #pstableid .. " " .. psiccldfail262
                    ...
                    if (psicgalochki[3][1] == 1 and psicgalochki[3][7] == 1) then
                        pszapuskanonsa(whererepiccchat[psicchatchoose[3][7]],
                                       psstringa)
                    end
...
function psiccldwsomeonedie(im)
    ...
    if psiccldwtable1 and #psiccldwtable1 > 0 then
        ...
        if psicgalochki[3][1] == 1 and psicgalochki[3][4] == 1 and psdamagename3 and
            #psdamagename3 > 0 then
            if UnitSex(im) and UnitSex(im) == 3 then
                strochkadamageout = "{rt8}" .. im .. " " .. psiccladyfail3fem
            else
                strochkadamageout = "{rt8}" .. im .. " " .. psiccladyfail3
            end
            reportfromtwodamagetables3(whererepiccchat[psicchatchoose[3][4]],
                                       nil, 5)
        end
        psdamagename3 = nil
        psdamagevalue3 = nil
...
function psficcladydeathafterf()
    if (psicgalochki[3][1] == 1 and psicgalochki[3][2] == 1) then
        ...
        reportafterboitwotab(whererepiccchat[psicchatchoose[3][2]], true,
                             vezaxname, vezaxcrash, 1, 7)
    end

    if (psicgalochki[3][1] == 1 and psicgalochki[3][9] == 1) then
        strochkavezcrash = "{rt3} " .. psiccladyfail14
        reportafterboitwotab(whererepiccchat[psicchatchoose[3][9]], true,
                             vezaxname3, vezaxcrash3, 1, 7)
    end

    if (psicgalochki[3][1] == 1 and psicgalochki[3][3] == 1 and psdamagename2 and
        #psdamagename2 > 0) then
        strochkadamageout = "{rt4} " .. psiccladyfail2
        reportfromtwodamagetables(whererepiccchat[psicchatchoose[3][3]], 1, nil,
                                  8, true)
    end

    if (psicgalochki[3][1] == 1 and psicgalochki[3][5] == 1 and
        psiccldghostdmgname and #psiccldghostdmgname > 0) then
        ...
        reportafterboitwotab(whererepiccchat[psicchatchoose[3][5]], true,
                             vezaxname2, vezaxcrash2, 1, 7)
    end

    if (psicgalochki[3][1] == 1 and psicgalochki[3][6] == 1 and
        psiccldghosttrigname and #psiccldghosttrigname > 0) then
        table.wipe(vezaxname2)
        table.wipe(vezaxcrash2)
        ...
        reportafterboitwotab(whererepiccchat[psicchatchoose[3][6]], true,
    ...
    if psiccsavfile and (psicclastsaverep == nil or (psicclastsaverep and
        ...
        strochkavezcrash = "{rt3} " .. psiccladyfail1
        reportafterboitwotab(whererepiccchat[psicchatchoose[3][2]], true,
                             vezaxname, vezaxcrash, 1, 10, 0, 1)

        strochkavezcrash = "{rt3} " .. psiccladyfail14
        reportafterboitwotab(whererepiccchat[psicchatchoose[3][9]], true,
                             vezaxname3, vezaxcrash3, 1, 10, 0, 1)

        if psdamagename2 and #psdamagename2 > 0 then
            strochkadamageout = "{rt4} " .. psiccladyfail2
            reportfromtwodamagetables(whererepiccchat[psicchatchoose[3][3]], 1,
                                      nil, 10, true, 0, 1)
        end
        ...
        if psiccldghostdmgname and #psiccldghostdmgname > 0 then
            ...
            strochkavezcrash = "{rt1} " .. psiccldfail25
            reportafterboitwotab(whererepiccchat[psicchatchoose[3][6]], true,
                                 vezaxname2, vezaxcrash2, nil, 25, 0, 1)
