    ...
    if (IsRaidOfficer() == 1) then
        if (PSFmain5_RadioButton251:GetChecked()) then
            ...
            if (PSFmain5_timerpereriv1:GetNumber() > 0 and
                PSFmain5_timerpereriv1:GetNumber() < 31) then
                skokasecpereriv = PSFmain5_timerpereriv1:GetNumber() * 60

                SendChatMessage(
                    pstimerstarts .. " '" .. pspereriv .. "' -> " ..
                        PSFmain5_timerpereriv1:GetNumber() .. " " .. psmin ..
                        " " .. pstwobm, "raid_warning")
            ...
            if (PSFmain5_timerpereriv1:GetNumber() > 29) then
                skokasecpereriv = math.fmod(PSFmain5_timerpereriv1:GetNumber(),
                                            60)
                skokaminpereriv = math.floor(
                                      PSFmain5_timerpereriv1:GetNumber() / 60)

                SendChatMessage(
                    pstimerstarts .. " '" .. pspereriv .. "' -> " ..
                        skokaminpereriv .. " " .. psmin .. " " ..
                        skokasecpereriv .. " " .. pssec .. " " .. pstwobm,
                    "raid_warning")
    ...
    if (IsRaidOfficer() == 1) then
        if (PSFmain5_RadioButton253:GetChecked()) then
            ...
            if (PSFmain5_timersvoi1:GetNumber() > 0 and
                PSFmain5_timersvoi1:GetNumber() < 121) then
                skokasecpereriv = PSFmain5_timersvoi1:GetNumber() * 60

                SendChatMessage(
                    pstimerstarts .. " '" .. nazvtimera .. "' -> " ..
                        PSFmain5_timersvoi1:GetNumber() .. " " .. psmin .. " " ..
                        pstwobm, "raid_warning")
            ...
            if (PSFmain5_timersvoi1:GetNumber() > 9) then
                ...
                skokaminpereriv = math.floor(
                                      PSFmain5_timersvoi1:GetNumber() / 60)
