...
function addtotridamagetablesphase3(nicktoadd, damagetoadd, count)
    ...
    if (psdamagenamep3 == nil or psdamagenamep3 == {}) then
        psdamagenamep3 = {}
    end
    if (psdamagevaluep3 == nil or psdamagevaluep3 == {}) then
        psdamagevaluep3 = {}
    end
    ...
    for i, getcrash in ipairs(psdamagenamep3) do
        if getcrash == nicktoadd then
            psdamagevaluep3[i] = psdamagevaluep3[i] + damagetoadd
            psdamagerazp3[i] = psdamagerazp3[i] + count
            bililine = 1
        end
    end
    if (bililine == 0) then
...
function psiccsindratoombsnoobs1(arg6, arg7)
    ...
    if psunitplayertrue then
        ...
        for i = 1, #psiccsindmarks do
            if arg7 == psiccsindmarks[i] then bililinet = 1 end
        end

        if bililinet == 0 then
            local bilininet2 = 0
            for i = 1, #psiccsindmarks2 do
                if arg7 == psiccsindmarks2[i] then bilininet2 = 1 end
            end
...
function psiccsindradebnoob2(arg1, arg4, arg7, arg9, arg10, arg12, arg13)
    ...
    if dif and dif == 1 then percent = 20 end

    if UnitSex(arg7) and UnitSex(arg7) == 3 then
        psstringa = "{rt8} " .. arg7 .. " " .. psiccfailtxt11511fem ..
                        " \124cff71d5ff\124Hspell:" .. arg9 .. "\124h[" .. arg10 ..
                        "]\124h\124r " .. psiccfailtxt11512
    else
        psstringa = "{rt8} " .. arg7 .. " " .. psiccfailtxt11511 ..
                        " \124cff71d5ff\124Hspell:" .. arg9 .. "\124h[" .. arg10 ..
                        "]\124h\124r " .. psiccfailtxt11512
    end
    ...
    for i = 1, #psiccsinddebuf1 do
        if psiccsinddebuf1[i] == arg4 then
            ...
            if psiccsinddebufunk1 and #psiccsinddebufunk1 > 0 then
                ...
                for oo = 1, #psiccsinddebufunk1 do
                    if psiccsinddebufunk1[oo] == arg7 then
                        if arg1 - psiccsinddebufunk2[oo] < 8 then
                            biltutne = 1
                            psstringa =
                                psstringa .. " + " .. tainstven .. " (x" ..
                                    psiccsinddebufunk3[oo] .. ", " ..
                                    (psiccsinddebufunk3[oo] * percent) ..
                                    "%) > " .. (arg12 - arg13) .. " (" ..
                                    psiccoverdmg .. ": " .. arg13 .. ")"
                        end
                    end
                ...
                if biltutne == 0 then
                    psstringa = psstringa .. " + " .. tainstven ..
                                    " (x0, 0%) > " .. (arg12 - arg13) .. " (" ..
                                    psiccoverdmg .. ": " .. arg13 .. ")"
                end

            else
                psstringa = psstringa .. " > " .. (arg12 - arg13) .. " (" ..
                                psiccoverdmg .. ": " .. arg13 .. ")"
            end
...
function psiccsindradebnoobice2(arg1, arg7, arg9, arg10, arg12, arg13)
    ...
    for oo = 1, #psiccsinddebufunk1 do
        if psiccsinddebufunk1[oo] == arg7 then
            if arg1 - psiccsinddebufunk2[oo] < 8 then
                psstringa = psstringa .. tainstven .. " (x" ..
                                psiccsinddebufunk3[oo] .. ", " ..
                                (psiccsinddebufunk3[oo] * percent) .. "%) > " ..
                                (arg12 - arg13) .. " (" .. psiccoverdmg .. ": " ..
                                arg13 .. ")"

                if (psicgalochki[12][1] == 1 and psicgalochki[12][6] == 1) then
                    pszapuskanonsa(whererepiccchat[psicchatchoose[12][6]],
                                   psstringa)
                end
...
function reportfromtridamagetablesp3(inwhichchat, maxpers, qq, bojinterr, iccra,
                                     norep)
    if psdamagevaluep3 and psdamagevaluep3[1] > 0 then
        ...
        if (psdamagerazp3 == nil or psdamagerazp3 == {}) then
            psdamagerazp3 = {}
        end
                ...
                if psdamagevaluep3[i] and psdamagevaluep3[i] > 0 then
                    ...
                    if (string.len(psdamagevaluep3[i])) > 3 then
                        psinfoshieldtempdamage =
                            string.sub(psdamagevaluep3[i], 1,
                                       string.len(psdamagevaluep3[i]) - 3)
                ...
                if i == vzxnn then
                    ...
                    if psdamagevaluep3[i] and psdamagevaluep3[i] > 0 then
                        if (string.len(strochkadamageout) > 230 and qq == nil) then
                            strochkavezcrash2 =
                                strochkavezcrash2 .. psdamagenamep3[i] .. " (" ..
                                    psinfoshieldtempdamage .. " - " ..
                                    psdamagerazp3[i] .. ")" .. pstochki
                        else
                            strochkadamageout =
                                strochkadamageout .. psdamagenamep3[i] .. " (" ..
                                    psinfoshieldtempdamage .. " - " ..
                                    psdamagerazp3[i] .. ")" .. pstochki
                        end
                    end
                    pszapuskanonsa(inwhichchat, strochkadamageout, bojinterr,
                                   nil, iccra, norep)

                    if (string.len(strochkavezcrash2) > 3 and qq == nil) then
                        pszapuskanonsa(inwhichchat, strochkavezcrash2,
                                       bojinterr, nil, iccra, norep)
                    end
                else
                    if psdamagevaluep3[i] and psdamagevaluep3[i] > 0 then
                        if (string.len(strochkadamageout) > 230 and qq == nil) then
...
function psficcsindraafterf()
    ...
    if psiccinst == "10" or psiccinst == "25" then
        ...
        if (psicgalochki[12][1] == 1 and psicgalochki[12][8] == 1) then
            ...
            reportfromtridamagetablesp3(whererepiccchat[psicchatchoose[12][8]],
                                        12, 1, true)
        end
    end
    ...
    if (psicgalochki[12][1] == 1 and psicgalochki[12][9] == 1) then
        ...
        reportafterboitwotab(whererepiccchat[psicchatchoose[12][9]], true,
                             vezaxname4, vezaxcrash4, 1, 10)
    end
    ...
    if psiccsavfile and (psicclastsaverep == nil or (psicclastsaverep and
        ...
        strochkavezcrash = "{rt1} " .. psiccfailtxt113
        reportafterboitwotab(whererepiccchat[psicchatchoose[12][4]], true,
                             vezaxname3, vezaxcrash3, nil, 20, 0, 1)
        ...
        strochkavezcrash = "{rt7} " .. psiccbossfail118t
        reportafterboitwotab(whererepiccchat[psicchatchoose[12][9]], true,
                             vezaxname4, vezaxcrash4, 1, 15, 0, 1)
