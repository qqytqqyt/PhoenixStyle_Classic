            ...
            if pswipetrue then
                ...
                if (psicgalochki[8][1] == 1 and psicgalochki[8][7] == 1) then
                    if UnitSex(arg7) and UnitSex(arg7) == 3 then
                        pszapuskanonsa(whererepiccchat[psicchatchoose[8][7]],
                                       "{rt8} " .. arg7 .. " - " ..
                                           psiccbossfailtext76fem)
                    else
                        pszapuskanonsa(whererepiccchat[psicchatchoose[8][7]],
                                       "{rt8} " .. arg7 .. " - " ..
                                           psiccbossfailtext76)
...
function psficcprofafterf()
    if psiccfestertrig == nil then
        ...
        if (psicgalochki[8][1] == 1 and psicgalochki[8][3] == 1) then
            ...
            reportafterboitwotab(whererepiccchat[psicchatchoose[8][3]], true,
                                 vezaxname2, vezaxcrash2, 1, 7)
        end

        if (psicgalochki[8][1] == 1 and psicgalochki[8][4] == 1) then
            strochkavezcrash = "{rt7} " .. psiccfailtxt73
            reportafterboitwotab(whererepiccchat[psicchatchoose[8][4]], true,
                                 vezaxname3, vezaxcrash3, 1, 7)
        end

        if (psicgalochki[8][1] == 1 and psicgalochki[8][2] == 1) then
            strochkavezcrash = "{rt7} " .. psiccfailtxt71
            reportafterboitwotab(whererepiccchat[psicchatchoose[8][2]], true,
                                 vezaxname, vezaxcrash, 1, 7)
        end

        if psiccsavfile and (psicclastsaverep == nil or (psicclastsaverep and
            ...
            strochkavezcrash = "{rt7} " .. psiccfailtxt72
            reportafterboitwotab(whererepiccchat[psicchatchoose[8][3]], true,
                                 vezaxname2, vezaxcrash2, 1, 15, 0, 1)
            strochkavezcrash = "{rt7} " .. psiccfailtxt73
            reportafterboitwotab(whererepiccchat[psicchatchoose[8][4]], true,
                                 vezaxname3, vezaxcrash3, 1, 15, 0, 1)
            strochkavezcrash = "{rt7} " .. psiccfailtxt71
            reportafterboitwotab(whererepiccchat[psicchatchoose[8][2]], true,
                                 vezaxname, vezaxcrash, nil, 25, 0, 1)
            psiccrefsvin()
        end
...
function psiccprofmenu()
    if psicgalochki[1][1] == 1 then
        ...
        if (psiccprofgal1) then
            PSFiccprofframe_CheckButton1:SetChecked(true)
        else
            PSFiccprofframe_CheckButton1:SetChecked(false)
        end
        if (psiccprofgal2) then
            PSFiccprofframe_CheckButton2:SetChecked(true)
        else
            PSFiccprofframe_CheckButton2:SetChecked(false)
        end
        if (psiccprofgal22) then
            PSFiccprofframe_CheckButton22:SetChecked(true)
        else
            PSFiccprofframe_CheckButton22:SetChecked(false)
        end
        if (psiccprofgal23) then
            PSFiccprofframe_CheckButton23:SetChecked(true)
        else
            PSFiccprofframe_CheckButton23:SetChecked(false)
        end
        if (psiccprofgal3) then
            PSFiccprofframe_CheckButton3:SetChecked(true)
        else
            PSFiccprofframe_CheckButton3:SetChecked(false)
        end
        if (psiccprofgal5) then
            PSFiccprofframe_CheckButton5:SetChecked(true)
        else
            PSFiccprofframe_CheckButton5:SetChecked(false)
        end
        ...
        if psflanadrawpr == nil then
            ...
            -- онентерпрессед
            PSFiccprofframe_edbox1:SetScript("OnEnterPressed", function(self)
                psiccignlistaddprof()
            end)
            PSFiccprofframe_edbox2:SetScript("OnEnterPressed", function(self)
                psiccignlistaddprof2()
            end)
            ...
            for i = 1, 6 do
                ...
                o:SetTexture(
                    "Interface\\TARGETINGFRAME\\UI-RaidTargetingIcon_" .. i)
                ...
                -- checkbuttons
                local q = CreateFrame("CheckButton", nil, PSFiccprofframe,
                                      "UICheckButtonTemplate")
                q:SetWidth("25")
                q:SetHeight("25")
                q:SetPoint("TOPLEFT", 357 + 25 * i, -210)
                q:SetScript("OnClick", function(self)
                    PSFiccprofmg(i)
                end)
...
function PSFiccprofmg(nr)
    ...
    for i = 1, 6 do
        if psiccprofchb[i] == 1 then
            ...
            psiccprofdrowtable2[i]:SetChecked(true)
        else
...
function psiccreflignorlistprof()
    if #psiccprofignorlist1 == 0 then
        ...
        for i = 1, #psiccprofignorlist1 do
            ...
            if psiccclassfound then
                pslist = pslist .. psiccclassfound .. psiccprofignorlist1[i] ..
                             "|r"
            else
    ...
    if #psiccprofignorlist2 == 0 then
        ...
        for i = 1, #psiccprofignorlist2 do
            ...
            if psiccclassfound then
                pslist = pslist .. psiccclassfound .. psiccprofignorlist2[i] ..
                             "|r"
            else
...
function psiccignlistaddprof()
    if string.len(PSFiccprofframe_edbox1:GetText()) > 1 then
        local bililinet = 0
        for i = 1, #psiccprofignorlist1 do
            if string.lower(psiccprofignorlist1[i]) ==
                string.lower(PSFiccprofframe_edbox1:GetText()) then
                bililinet = 1
            end
        end
        ...
        if bililinet == 0 then
            ...
            out("|cff99ffffPhoenixStyle|r - |cff00ff00'" ..
                    PSFiccprofframe_edbox1:GetText() .. "'|r " ..
                    psicclanaerrprof3)
            psiccreflignorlistprof()
        else
            out("|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror .. "|r '" ..
                    PSFiccprofframe_edbox1:GetText() .. "' - " .. psicclanaerr2)
        end
...
function psiccignlistremprof()
    if string.len(PSFiccprofframe_edbox1:GetText()) > 1 then
        ...
        for i = 1, #psiccprofignorlist1 do
            if psiccprofignorlist1[i] and PSFiccprofframe_edbox1:GetText() then
                if string.lower(psiccprofignorlist1[i]) ==
                    ...
                    out("|cff99ffffPhoenixStyle|r - |cffff0000'" ..
                            PSFiccprofframe_edbox1:GetText() .. "'|r " ..
                            psicclanaerr4)
                    psiccreflignorlistprof()
                    PSFiccprofframe_edbox1:SetText("")
        ...
        if bililinet == 0 then
            out("|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror .. "|r '" ..
                    PSFiccprofframe_edbox1:GetText() .. "' " .. psicclanaerr5)
        end
...
function psiccignlistaddprof2()
    if string.len(PSFiccprofframe_edbox2:GetText()) > 1 then
        local bililinet = 0
        for i = 1, #psiccprofignorlist2 do
            if string.lower(psiccprofignorlist2[i]) ==
                string.lower(PSFiccprofframe_edbox2:GetText()) then
                bililinet = 1
            end
        end
        ...
        if bililinet == 0 then
            ...
            out("|cff99ffffPhoenixStyle|r - |cff00ff00'" ..
                    PSFiccprofframe_edbox2:GetText() .. "'|r " ..
                    psicclanaerrprof13)
            psiccreflignorlistprof()
        else
            out("|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror .. "|r '" ..
                    PSFiccprofframe_edbox2:GetText() .. "' - " .. psicclanaerr2)
        end
...
function psiccignlistremprof2()
    if string.len(PSFiccprofframe_edbox2:GetText()) > 1 then
        ...
        if bililinet == 0 then
            out("|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror .. "|r '" ..
                    PSFiccprofframe_edbox2:GetText() .. "' " .. psicclanaerr5)
        end
    ...
    if (thisaddonwork and (psicgalochki == nil or psicgalochki[1][1] == 1)) then
        ...
        if psiccprofwispchuma2 then
            ...
            local _, _, _, _, _, expirationTime = psf_unitaura(
                                                         ...
                                                         psideb1)
            local timean = 5
            if psiccprofwispchuma1 and psiccprofwispchuma1 - GetTime() > 2 and
                psiccprofwispchuma1 - GetTime() < 20 then
                timean = (psiccprofwispchuma1 - GetTime()) + 3
            end

            if expirationTime == nil or
                (expirationTime and expirationTime - GetTime() < timean) then
                normcont = 2
            end
        else
            normcont = 2
        ...
        if normcont == 1 then
            ...
            if #usemarks > 0 then
                        ...
                        for i = 1, GetNumGroupMembers() do
                            ...
                            if (subgroup <= psgropcheck and online and isDead ==
                                    ...
                                    if UnitExists(name) and
                                        (GetRaidTargetIndex(name) == nil or
                                            (GetRaidTargetIndex(name) and
                                                GetRaidTargetIndex(name) ~= 8)) then
                                    ...
                                    if UnitExists(name) and
                                        ...
                                        if usemarks and #usemarks > 0 then
                                            for tr = 1, #usemarks do
                                                if GetRaidTargetIndex(name) ==
                                                    usemarks[tr] then
                                                    if ((UnitIsGroupAssistant(
                                                        "player") or
                                                        UnitIsGroupLeader(
                                                            "player"))) then
                                ...
                                for yy = 1, #psiccprofignorlist2 do
                                    if string.lower(psiccprofignorlist2[yy]) ==
                ...
                elseif psiccprofgal3 == true then
                        ...
                        if (subgroup <= psgropcheck and online and isDead == nil and
                            ...
                            if (psf_unitaura(name, psdeb2) == nil or
                                ...
                                for yy = 1, #psiccprofignorlist1 do
                                    if string.lower(psiccprofignorlist1[yy]) ==
                                        string.lower(name) then
                                        bililinet = 1
                                    end
                                end
                    ...
                    if locx1 > 0 and #pstable1 > 0 then
                        ...
                        for e = 1, #pstable1 do
                            local locx2, locy2 =
                                GetPlayerMapPosition(pstable1[e])
                            if locx2 > 0 then
                                local rasst = math.sqrt(math.pow(
                                                            (locx1 - locx2), 2) +
                                                            math.pow(
                                                                (locy1 - locy2),
                                                                2))
                    ...
                    if psdamagevalue3 and #psdamagevalue3 > 0 then
                        ...
                        while uu > 0 do
                            -- метим если j меньше табл
                            if j <= #usemarks then
                                if UnitExists(psdamagename3[uu]) and
                                    (GetRaidTargetIndex(psdamagename3[uu]) ==
                                        nil or
                                        (GetRaidTargetIndex(psdamagename3[uu]) and
                                            GetRaidTargetIndex(psdamagename3[uu]) ~=
                                            usemarks[j])) then
                                    if ((UnitIsGroupAssistant("player") or
                                        UnitIsGroupLeader("player"))) then
                                        SetRaidTarget(psdamagename3[uu],
                                                      usemarks[j])
                                    end
                                    if firstmarkset then
                                        firstmarkset = nil
                        ...
                        while ii > 0 do
                            ...
                            while mm <= #pstable1 do
                                if psiccprofignorlist2[ii] and pstable1[mm] then
                                    if string.lower(psiccprofignorlist2[ii]) ==
                                        string.lower(pstable1[mm]) then
                                        table.remove(pstable1, mm)
                                        table.insert(pstable1, 1,
                                                     psiccprofignorlist2[ii])
                                        mm = 50
                                    end
                                end
                                mm = mm + 1
                    ...
                    for oo = 1, #pstable1 do
                        -- метим если j меньше табл
                        if j <= #usemarks then
                            if UnitExists(pstable1[oo]) and
                                (GetRaidTargetIndex(pstable1[oo]) == nil or
                                    (GetRaidTargetIndex(pstable1[oo]) and
                                        GetRaidTargetIndex(pstable1[oo]) ~=
                                        usemarks[j])) then
                                if ((UnitIsGroupAssistant("player") or
                                    UnitIsGroupLeader("player"))) then
            ...
            if psiccprofgal23 and psiccprofwispchuma1 then
                ...
                if psiccprofsendonemes then
                    ...
                    if psiccfirstmarkprofwispl then
                        SendChatMessage(
                            "{rt1} >>> " .. psiccfirstmarkprofwispl .. " <<< " ..
                                psiccprofpreptotake, "raid")
                        SendChatMessage(psiccprofpreptotake, "WHISPER", nil,
                                        psiccfirstmarkprofwispl)
                    ...
                    elseif psiccfirstmarkprofwisp and psiccfirstmarkprofwispl and
                        psiccfirstmarkprofwisp ~= psiccfirstmarkprofwispl then
                        SendChatMessage(
                            "{rt1} >>> " .. psiccfirstmarkprofwispl .. " <<< " ..
                                psiccprofpreptotake .. " {rt8} " ..
                                (string.upper(psiccprofpreptotake2)), "raid")
                        SendChatMessage(psiccprofpreptotake, "WHISPER", nil,
                                        psiccfirstmarkprofwispl)
                        psdelayprofmod = GetTime() + 30
            ...
            elseif psiccprofgal23 and psiccprofwispchuma1 == nil and
                psiccprofsendonemes == nil and psiccfirstmarkprofwisp and
                psiccfirstmarkprofwispl and psiccfirstmarkprofwisp ~=
                psiccfirstmarkprofwispl and psiccprofwispchuma22 then
                -- смена цели после сообщ что пора забирать
                SendChatMessage("{rt8}{rt8}{rt8} " .. psiccfirstmarkprofwisp ..
                                    " " .. pscanttakeplag, "WHISPER", nil,
                                psiccprofwispchuma22)
                SendChatMessage("{rt8}{rt8}{rt8} " .. psiccfirstmarkprofwisp ..
                                    " " .. pscanttakeplag, "raid")
...
function psfprofgalchang(nr)
    ...
    if PSFiccprofframe_CheckButton1:GetChecked() or
        PSFiccprofframe_CheckButton3:GetChecked() then
...
function psficcprofmodon()
    -- if((UnitIsGroupAssistant("player") or UnitIsGroupLeader("player"))) then
    psiccprofactiv = 1
    out("|cff99ffffPhoenixStyle|r - " .. psiccputricide .. ": |cff00ff00" ..
            psmoduletxton .. "|r")
    PSFiccprofframe_Textmarkon:Show()
    PSFiccprofframe_Buttonon:Hide()
    PSFiccprofframe_Textmarkoff:Hide()
...
function psficcprofmodoff()
    ...
    out("|cff99ffffPhoenixStyle|r - " .. psiccputricide .. ": |cffff0000" ..
            psmoduletxtoff .. "|r")
end
...
function psiccprofcheckspam(ttt)
    if psiccprofchumanorm == nil then
        ...
        if UnitName("player") == "Шуршик" or UnitName("player") ==
            "Шурши" then nam = "00" .. UnitName("player") end
        if (UnitIsGroupAssistant("player") or UnitIsGroupLeader("player")) then
            nam = "0" .. nam
        end
