    ...
    if psbossblock == nil then
        ...
        if psunitplayertrue then
            ...
            if pswipetrue then
                ...
                wasornolk = 1
                if psiccdefspawn and psicclichdelfireon and arg7 ==
                    psicclichdelfireon then
                    psiccdefspawn = nil
                else
                    addtotwotables(arg7)
                    vezaxsort1()
...
function psficclkafterf()
    ...
    if psiccschet3 > 4 then
        if (psicgalochki[13][1] == 1 and psicgalochki[13][2] == 1) then
            ...
            reportafterboitwotab(whererepiccchat[psicchatchoose[13][2]], true,
    ...
    if (psicgalochki[13][1] == 1 and psicgalochki[13][6] == 1) then
        ...
        reportfromtwodamagetables3(whererepiccchat[psicchatchoose[13][6]], true,
                                   6)
    end

    if (psicgalochki[13][1] == 1 and psicgalochki[13][7] == 1) then
        if psiccschet4 > 0 then
            pszapuskanonsa(whererepiccchat[psicchatchoose[13][7]],
                           "{rt6}" .. psicclkfailduh .. psiccschet4 .. ".", true)
        end
    end
    ...
    if psiccsavfile and (psicclastsaverep == nil or (psicclastsaverep and
        ...
        if psiccschet4 > 0 then
            pszapuskanonsa(whererepiccchat[psicchatchoose[13][7]],
                           "{rt6}" .. psicclkfailduh .. psiccschet4 .. ".",
                           true, nil, 0, 1)
        end
        psiccrefsvin()
    end
