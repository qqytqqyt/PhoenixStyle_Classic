            ...
            if pswipetrue then
                ...
                if (psicgalochki[6][1] == 1 and psicgalochki[6][7] == 1) then
                    if UnitSex(arg7) and UnitSex(arg7) == 3 then
                        pszapuskanonsa(whererepiccchat[psicchatchoose[6][7]],
                                       "{rt8} " .. arg7 .. " - " ..
...
function psficcfestergutafterf()
    if (psicgalochki[6][1] == 1 and psicgalochki[6][3] == 1) then
        ...
        reportafterboitwotab(whererepiccchat[psicchatchoose[6][3]], true,
                             vezaxname3, vezaxcrash3, 1, 7)
    end

    if (psicgalochki[6][1] == 1 and psicgalochki[6][2] == 1) then
        pszapuskanonsa(whererepiccchat[psicchatchoose[6][2]],
                       "{rt7} " .. psiccfailtxt51 .. psiccschet2, true)
    end

    if (psicgalochki[6][1] == 1 and psicgalochki[6][6] == 1) then
        strochkavezcrash = "{rt7} " .. psiccfailtxt71
        reportafterboitwotab(whererepiccchat[psicchatchoose[6][6]], true,
                             vezaxname4, vezaxcrash4, 1, 7)
    end
    ...
    if psiccsavfile and (psicclastsaverep == nil or (psicclastsaverep and
        ...
        if psiccfestertrig then
            ...
            pszapuskanonsa(whererepiccchat[psicchatchoose[6][2]],
                           "{rt7} " .. psiccfailtxt51 .. psiccschet2, true, nil,
                           0, 1)
            ...
            strochkavezcrash = "{rt7} " .. psiccfailtxt71
            reportafterboitwotab(whererepiccchat[psicchatchoose[6][6]], true,
                                 vezaxname4, vezaxcrash4, nil, 20, 0, 1)
...
function psiccfestergutaoealarm()
    ...
    if dif and dif == 1 then inst = "heroic" end

    -- 4 вкл и норм инст, или 4 вкл, 5 откл, и героик инст
    if psicgalochki[6][1] == 1 and psicgalochki[6][4] == 1 and
        (inst == "normal" or (psicgalochki[6][5] == 0 and inst == "heroic")) then
    ...
    elseif psicgalochki[6][1] == 1 and psicgalochki[6][5] == 1 and inst ==
        "heroic" then
        -- hard
        ...
        if #pstabl1 > 0 or #pstabl2 > 0 or #pstabl3 > 0 then
            pszapuskanonsa(whererepiccchat[psicchatchoose[6][5]],
                           "{rt8} " .. psiccfailtxt53)
        end
