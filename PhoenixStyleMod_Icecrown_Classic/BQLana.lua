...
function icclananoob2()
    if psiccschet == 1 then
        ...
        psiccschet3 = GetTime()
        if string.len(psicclalanames) > 1 then
            psicclalanames = psicclalanames .. ", "
        end
    ...
    if psiccschet2 == 0 and psiccschet3 > 0 then
        ...
        if psbossblock == nil then
            ...
            if (psicgalochki[10][1] == 1 and psicgalochki[10][3] == 1) then
                ...
                pszapuskanonsa(whererepiccchat[psicchatchoose[10][3]],
                               "{rt7}" .. psiccfailtxt92 .. " " .. bonekilled ..
                                   " " .. pssec .. " (" .. psicclalanames ..
                                   ").")
            end
        end
...
function psficclanaafterf()
    if (psicgalochki[10][1] == 1 and psicgalochki[10][2] == 1) then
        if psiccbonetime then
            ...
            pszapuskanonsa(whererepiccchat[psicchatchoose[10][2]],
                           "{rt4}" .. psiccfailtxt91 .. ": " .. psiccbonetime[1] ..
                               " " .. pssec .. " (" .. psiccbonetime[2] .. "), " ..
                               psiccfailtxt911 .. ": " .. psiccbonetime[3] ..
                               " " .. pssec .. " (" .. psiccbonetime[4] .. ").",
                           1)
        end
    end
    ...
    if (psicgalochki[10][1] == 1 and psicgalochki[10][4] == 1) then
        ...
        reportafterboitwotab(whererepiccchat[psicchatchoose[10][4]], true,
                             vezaxname, vezaxcrash, 1, 7)
    end

    if psiccsavfile and (psicclastsaverep == nil or (psicclastsaverep and
        (GetTime() < psicclastsaverep + 3 or GetTime() > psicclastsaverep + 30))) then
        ...
        strochkavezcrash = "{rt7} " .. psiccfailtxt93
        reportafterboitwotab(whererepiccchat[psicchatchoose[10][4]], true,
                             vezaxname, vezaxcrash, nil, 20, 0, 1)
...
function psicclanamenu()
    if psicgalochki[1][1] == 1 then
        ...
        if (psicclanaga) then
            PSFicclana_CheckButton1:SetChecked(true)
        else
            PSFicclana_CheckButton1:SetChecked(false)
        end
        ...
        if psflanadraw1 == nil then
            ...
            PSFicclana_edbox1:SetScript("OnEnterPressed",
                                        function(self)
                psiccignlistadd()
            end)
            PSFicclana_edbox2:SetScript("OnEnterPressed",
                                        function(self)
                psiccignlistadd2()
            end)
...
function psiccreflignorlist()
    if #psicclanaignorlist == 0 then
        ...
        for i = 1, #psicclanaignorlist do
            ...
            if psiccclassfound then
                pslist = pslist .. psiccclassfound .. psicclanaignorlist[i] ..
                             "|r"
            else
    ...
    if #psicclanaignorlist2 == 0 then
        ...
        for i = 1, #psicclanaignorlist2 do
            ...
            if psiccclassfound then
                pslist = pslist .. psiccclassfound .. psicclanaignorlist2[i] ..
                             "|r"
            else
...
function psiccignlistadd()
    if string.len(PSFicclana_edbox1:GetText()) > 1 then
        local bililinet = 0
        for i = 1, #psicclanaignorlist do
            if string.lower(psicclanaignorlist[i]) ==
                string.lower(PSFicclana_edbox1:GetText()) then
                bililinet = 1
            end
        end
        ...
        if bililinet == 0 then
            ...
            out("|cff99ffffPhoenixStyle|r - |cff00ff00'" ..
                    PSFicclana_edbox1:GetText() .. "'|r " .. psicclanaerr3)
            psiccreflignorlist()
        else
            out("|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror .. "|r '" ..
                    PSFicclana_edbox1:GetText() .. "' - " .. psicclanaerr2)
        end
...
function psiccignlistrem()
    if string.len(PSFicclana_edbox1:GetText()) > 1 then
        ...
        if bililinet == 0 then
            out("|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror .. "|r '" ..
                    PSFicclana_edbox1:GetText() .. "' " .. psicclanaerr5)
        end
...
function psiccignlistadd2()
    if string.len(PSFicclana_edbox2:GetText()) > 1 then
        local bililinet = 0
        for i = 1, #psicclanaignorlist2 do
            if string.lower(psicclanaignorlist2[i]) ==
                string.lower(PSFicclana_edbox2:GetText()) then
                bililinet = 1
            end
        end
        ...
        if bililinet == 0 then
            ...
            out("|cff99ffffPhoenixStyle|r - |cff00ff00'" ..
                    PSFicclana_edbox2:GetText() .. "'|r " .. psicclanaerr13)
            psiccreflignorlist()
        else
            out("|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror .. "|r '" ..
                    PSFicclana_edbox2:GetText() .. "' - " .. psicclanaerr2)
        end
...
function psiccignlistrem2()
    if string.len(PSFicclana_edbox2:GetText()) > 1 then
        ...
        if bililinet == 0 then
            out("|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror .. "|r '" ..
                    PSFicclana_edbox2:GetText() .. "' " .. psicclanaerr5)
        end
            ...
            if psicczapusk10 == nil or GetTime() > psicczapusk10 then
                    ...
                    while ii > 0 do
                        ...
                        while mm <= #pstable2 do
                            if psicclanaignorlist2[ii] and pstable2[mm] then
                                if string.lower(psicclanaignorlist2[ii]) ==
                                    string.lower(pstable2[mm]) then
                                    table.remove(pstable2, mm)
                                    table.insert(pstable2, 1,
                                                 psicclanaignorlist2[ii])
                                    mm = 50
                                end
                            end
                            mm = mm + 1
                ...
                if #pstable1 > 8 then
                    ...
                    if bezum > 0 and psicclanaga then
                        out(
                            "|cff99ffffPhoenixStyle|r - |cffff0000" .. pserror ..
                                "|r " .. psicclanaerr10)
                        psicczapusk10 = nil
                        for i = 1, #pstable2 do
                        ...
                        if #pstable1 > 0 then
                            if #pstable2 > 0 then
                                ...
                                for tr = 1, #pstable1 do
                                    if pstable1[tr] then
                                        local _, uclass =
                                            UnitClass(pstable1[tr])
                                        if uclass == "ROGUE" or uclass ==
                                            "WARRIOR" or uclass == "DEATHKNIGHT" then
                                ...
                                if #pstable1 > 1 then
                                    for gb = 1, #pstable2 do
                                        if gb <= #pstable1 then
                                            local _, uuclass = UnitClass(
                                                                   pstable2[gb])
                                            if uuclass == "ROGUE" or uuclass ==
                                                "WARRIOR" or uuclass ==
                                                "DEATHKNIGHT" then
                                                table.insert(pstable2, 1,
                                                             pstable2[gb])
                                ...
                                if (#pstable1 == #pstable2 or
                                    (#pstable2 > 8 and #pstable1 == 8)) then
                                        ...
                                        if m < 9 then
                                            ...
                                            SendChatMessage(
                                                "PhoenixStyle > " ..
                                                    psicclanawhisp1 .. " {rt" ..
                                                    m .. "}" .. pstable2[i],
                                                "WHISPER", nil, pstable1[i])
                                            SendChatMessage(
                                                "PhoenixStyle > {rt" .. m .. "}" ..
                                                    psicclanawhisp2 .. " " ..
                                                    pstable1[i] .. "!",
                                                "WHISPER", nil, pstable2[i])
                                            table.insert(psicclanamarkref,
                                                         pstable2[i])
                                    ...
                                    if #pstable1 == 8 and #pstable2 > 8 and
                                        #pstable2 < 14 then
                                        local morfood = ""
                                        for i = 9, #pstable2 do
                                            morfood =
                                        ...
                                        SendChatMessage(
                                            "PhoenixStyle > " .. psicclanasendm ..
                                                " " .. psicclanasendm5 ..
                                                morfood, "raid_warning")
                                    else
                                        SendChatMessage(
                                            "PhoenixStyle > " .. psicclanasendm,
                                            "raid_warning")
                                ...
                                elseif #pstable1 > #pstable2 then
                                    ...
                                    for i = 1, #pstable1 do
                                        if pstable2[i] then
                                            ...
                                            SendChatMessage(psicclanawhisp3,
                                                            "WHISPER", nil,
                                                            pstable1[i])
                                            nofood =
                                                nofood .. pstable1[i] .. " "
                                    ...
                                    for i = 1, #pstable2 do
                                        if pstable1[i] then
                                            ...
                                            if m < 9 then
                                                ...
                                                table.insert(psicclanamarkref,
                                                             pstable2[i])
                                                table.insert(psicclanamarkref2,
                                                             m)
                                                morfood =
                                                    morfood .. "{rt" .. m .. "}" ..
                                                        pstable2[i] .. " "
                                ...
                                out("|cff99ffffPhoenixStyle|r - |cffff0000" ..
                                        pserror .. "|r " .. psicclanaerr12)
                            end
                        else
                            out("|cff99ffffPhoenixStyle|r - |cffff0000" ..
                                    pserror .. "|r " .. psicclanaerr11)
                            psicczapusk10 = nil
                        end
                    end
