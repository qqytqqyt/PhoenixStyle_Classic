...
function psicccouncilkilled1()
    ...
    if #vezaxname > 1 and psicgalochki[9][1] == 1 and psicgalochki[9][3] == 1 then
        ...
        strochkavezcrash = ""
        reportafterboitwotab(whererepiccchat[psicchatchoose[9][3]], false,
                             vezaxname, vezaxcrash, 1, 10)
    end
...
function psiccsovetdose2(arg4,arg7,arg9,arg10,arg12,arg13)
    ...
    for i = 1, #psiccsinddebuf1 do
        if psiccsinddebuf1[i] == arg4 then
            psstringa =
                psstringa .. psicchehas22 .. ": " .. psiccsinddebuf2[i] .. " > " ..
                    (arg12 - arg13) .. " (" .. psiccoverdmg .. ": " .. arg13 ..
                    ")"
...
function psficcsovetafterf()
    if (psicgalochki[9][1] == 1 and psicgalochki[9][4] == 1) then
        ...
        reportafterboitwotab(whererepiccchat[psicchatchoose[9][4]], true,
                             vezaxname3, vezaxcrash3, 1, 7)
    end
    if (psicgalochki[9][1] == 1 and psicgalochki[9][6] == 1) then
        strochkavezcrash = "{rt7} " .. psiccbossfail85f
        reportafterboitwotab(whererepiccchat[psicchatchoose[9][6]], true,
