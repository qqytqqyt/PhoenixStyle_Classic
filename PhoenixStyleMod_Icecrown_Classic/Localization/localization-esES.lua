if GetLocale() == "esES" then
    ...
    function pslocaleicecrownboss()
        ...
        psiccputricidepully =
            "¡Buenas noticias, amigos! Creo que he perfeccionado una plaga que destruirá toda la vida en Azeroth."
        ...
        psiccvalitriapull =
            "Han entrado intrusos en el Sagrario Interior. Apresuraos en acabar con el dragón verde. ¡Dejad solo huesos y tendones para la reanimación!"
