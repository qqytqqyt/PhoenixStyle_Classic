...
function pslocaleicecrownuim()
    ...
    psicchoosebosstxt =
        "To change boss options - choose in menu above which boss you need. There are |cff00ff00t|r|cffff0000w|r|cff00ff00o|r channels for msg, you can change them for any announce."
    ...
    psicmodulenotena =
        "Module \"Icecrown Citadel\" is disabled, you can't change boss options."
    psicmaintitle = "general options"
    psicpasmodtxt = "Passive modules:"
    psiccdeathtitle = "Lady Deathwhisper - announce options."
    psiccsaurfangtitle =
        "Show at the end of the fight who got attacks from adds, and how much times boss healed him self from attacking tanks. |cff00ff00Attention!|r This boss has special module to set marks for healers that they have to heal (button below)."
    psiccanons21 =
    ...
    psiccsaurmarktitl =
        "    Icecrown Citadel - Deathbringer Saurfang, marks assignments"
    ...
    psiccanons11 =
        "Announce at the end of the fight best and worst time of 'Bone Spike's' kill"
    ...
    psiccgunship51 =
        "Announce at the end of the fight who got damage from Rockets"
    ...
    psiccanons43 =
        "Announce the result (add attacks) every time when boss cast his Mark"
    psiccanons22 =
        "Announce at the end of the fight who did damage to players under MC"
    psiccladyfail2 = "Friendly fire (to players under MC): "
    psiccanons44 =
        "Announce how much times boss healed him self from melee attacks to tank with debuff"
    ...
    psiccbossfail61 =
        "Announce at the end of the fight who got damage from Slime Spray (boss breath)"
    psiccbossfail62 =
        "Announce at the end of the fight who got damage from missiles after Ooze Explosion"
    psiccbossfail71 =
        "Announce at the end of the fight who got damage from 'Malleable Goo'"
    ...
    psiccbossfail51 =
        "Announce at the end of the fight how much more 'Vile Gas' there were"
    psiccbossfail52 =
        "Announce at the end of the fight friendly attacks from vomit"
    psiccbossfail53 =
        "Announce before big AoE who have less then 2 defensive spore debuffs"
    ...
    psiccbossfail72 =
        "Announce at the end of the fight who got damage from Choking Gas Explosion"
    psiccbossfail73 =
        "Announce at the end of the fight who stand in Slime Puddle (sec.)"
    psiccbossfail74 =
        "Announce during fight if 'Unbound Plague' was given to a player with 'Plague Sickness' debuff"
    psiccbossfail75 = "Report info who did damage to adds during fight"
    psiccinfo71 =
        "|cff00ff00P.S.|r This module was written for normal mode, so when there are 2 ooze - time taken to switch target is tracking only for 1 ooze and for the second after the first die. Attention! Your switch time is lower than time of other raiders for your latency!"
    psiccozzen1 = "Add"
    psiccozzen2 = "(green)"
    psiccozzen3 = "(orange)"
    ...
    psiccdamageinfotitle =
        "    Information about damage and switch time on some bosses of Icecrown"
    ...
    psicctitle8 =
        "Count time lost to switch target, after 15 sec report best time (you can change quantity of names in 'Damage/Switch info' options)."
    psiccbossfail81 =
        "Report after 15 sec of boss switch - time lost to switch target"
    psiccbossfail82 =
        "Report who discharges 'Conjure Empowered Flame' if someone die from it"
    ...
    psiccbossfail91 =
        "Announce at the end of the fight best and worst time taken to remove 'Pact of the Darkfallen'"
    psiccbossfail92 =
        "Announce during fight time taken to remove 'Pact of the Darkfallen'"
    ...
    psiccbossfail93 =
        "Announce at the end of the fight friendy attacks (during Air phase)"
    psiccinfo81 =
        "|cff00ff00P.S.|r Is shown time taken to switch target (max 15 sec). Attention! Your switch time is lower than time of other raiders for your latency!"
    psicccounc1 = "Target switch"
    psiccinfonodata =
        "|cff00ff00P.S.|r This module is active for \"Deathbringer Saurfang\", \"Professor Putricide\", \"Blood Prince Council\" and \"The Lich King\", spam in chat during combat is disabled by default, you can change this in boss options."
    psiccfailtxt93 = "Friendly attacks (Air phase): "
    psicclanamarktitl =
        "    Icecrown Citadel - Blood-Queen Lana'thel, marks assignments for vampire"
    psicclanamarkinfo =
        "|cff00ff00What it do?|r It marks 8 dps players (not vampire) when you need them.\n|cff00ff00How it works?|r You have to enter command in chat '|cff00ff00/fen food|r' (better to use macro) - 8 marks will be set on players. Add healers and tanks to ignor list, no marks will be set on them. And add main dps to priority list. After bite mark will be set off. If 'random assignments' is enabled - marks will be divide between vampire and whispers will send to them. This module autoupdate marks every 2 sec (if some other addon tries to change them). Attention! 'BloodQueen' addon - has all this in automatic and has better functional."
    psicclanamarkinfo2 =
        "'Bad food' (healers, tanks, etc), marks would not be set to them:"
    ...
    psicctitle10 =
        "Announce at the end of the fight some information listed below. |cffff0000Attention!|r When you are inside portal - combatlog is disabled."
    psicctitle11 = "Announce some information listed below."
    psicctitle12 =
        "Count damage and switch-time to Val'kyr, reports info about defile during and after the fight, etc. When you are in Frostmourne room combatlog is disabled, addon will get low priority to announce info after the fight."
    psiccbossfail101 = "Who got damage from Column of Frost"
    psiccbossfail102 = "Who stand in Mana Void"
    psiccbossfail103 =
        "Who used 'Guardian Spirit' and replacement of this buff by another priest"
    ...
    psiccbossfail111 =
        "Announce at the end of the fight who got damage from boss AoE"
    psiccbossfail112 =
        "Announce at the end of the fight who got damage from 'Frost Bomb' (Air phase)"
    psiccbossfail113 =
        "Announce at the end of the fight max stacks of 'Mystic Buffet' on raiders (top-7)"
    psiccbossfail114 =
        "If there are more Ice Tombs than should be - announce who got them"
    psiccbossfail115 =
        "If someone dies from 'Backlash' or 'Ice Tomb' - announce how much stacks there were"
    ...
    psiccbossfail122 =
        "Announce during the fight who stand in Defile if there were more than 3 ticks"
    ...
    psiccinfo131 =
        "|cff00ff00P.S.|r For heroic mode it doesn't count damage if Val'kyr has <51% Hp. Attention! Your switch time is lower than time of other raiders for your latency!"
    psicclkvalkir = "Val'kyr"
    psicclkvalkir3 = "Three Val'kyr"
    psiccbossfail76 =
        "Announce during the fight who got damage from 'Malleable Goo' - attention! may be spamming!"
    psiccbossfailtext76 = "got Malleable Goo!"
    psiccunknown = "unknown"
    psiccoverdmg = "O"
    psiccfirst = "first"
    psiccbossfail125 =
        "Announce during the fight who healed debuff 'Harvest Soul'"
    psiccbossfail126 =
        "Announce who healed debuff 'Harvest Soul' if someone dies with it and after the fight"
    psiccbossfail127 =
        "Announce at the end of the fight how much spirits has exploded (0 for achievement)"
    ...
    psiccanons24 =
        "Announce at the end of the fight who got damage from Vengeful Shade's explosions"
    psiccanons25 =
        "Announce at the end of the fight who triggered Vengeful Shade's explosions"
    psiccanons26 =
        "If someone got damage from explosion and then died - report who triggered ghost"
    ...
    psiccinfo141 =
        "|cff00ff00P.S.|r Attention! Your switch time is lower than time of other raiders for your latency!"
    psiccsauraddev = "Blood Beast's wave"
    psiccanons46 =
        "Announce at the end of the fight how much people got Blood Nova simultaneously (max)"
    psiccanons46failtxt = "Blood Nova, max simultaneously damage: "
    psiccbossfail128 = "Announce during the fight who stand in Defile"
    psiccbossfail54 =
        "Announce before big AoE who have less then 3 defensive spore debuffs (heroic only)"
    psiccbossfail55 =
        "Announce at the end of the fight who got damage from 'Malleable Goo' (heroic)"
    psiccbossfail56 =
        "Announce during the fight who got damage from 'Malleable Goo' - attention! may be spamming!"
    tpsicinforezettxt =
        "To reset chat channels and report options for \"Icecrown\" module - click reset button twice"
    psiccrezonemore =
        "Click reset button one more time if you want to reset options!"
    psiccrezcompl = "All changes in \"Icecrown\" module were reseted."
    psiccbossfail77 =
        "If someone dies from 'Unbound Plague' report how much seconds he had it"
    psiccza = "in"
    ...
    psiccpasmod3tit =
        "    Icecrown Citadel - Professor Putricide, marks for heroic mode"
    psiccprofmarkinfo =
        "Module marks Unbound Plague as skull and players that can take it with other marks. An arrow is showing if AVR is installed. There are options for 3 different tactics. |cffff0000Attention!|r Many BossMods uses marks on this encounter, it's suggested to disable marks which you choose in this module"
    ...
    psiccprofnotenough =
        "This option needs atleast 4 players in the priority list."
    psiccprofusemark = "marks in use:"
    psiccprofmodopt3 =
        "Marks players by the range to player with 'Unbound Plague', exception ignor list (|cff00ff00most used|r)"
    psiccproftacttxt1 = "Marks will be set only on players from priority list"
    psiccproftacttxt2 =
        "Marks will be set by range check, exception ignor list. Range will be check and marks will be update every 2 sec if you use this only for marking"
    ...
    psiccbossfail83 =
        "Announce at the end of the fight max stacks of 'Shadow Prison' on raiders (top-7)"
    psiccbossfail84 =
        "If someone die from 'Shadow Prison' - report how much stacks there were"
    psiccfailtxt844 = "Max stacks of Shadow Prison: "
    psiccprofmanyaddons =
        "There is 1 more module enabled in your raid. Your module is disabled for this fight!"
    psiccwhispertxt = "whisper:"
    psiccwhispertxt2 = "in chat:"
    psiccheroic = "heroic"
    psiccinfoabsv = "Info about"
    psiccanons27 =
        "Announce during the fight who triggered Vengeful Shade's explosions (may be spamming)"
    ...
    psiccbossfail116 =
        "Announce friendly dmg (not self) from 'Backlash' (sort - dmg/quantity of debuffs) - 1 phase"
    ...
    psiccbossfail85 =
        "Announce at the end of the fight friendly damage from 'Empowered Shock Vortex'"
    ...
    psiccprofmodopt23go =
        "PhoenixStyle > Time to take 'Unbound Plague' from {rt8}!"
    psiccladyfail14 = "Vampiric Might, dispelled: "
    psiccanons28 =
        "Announce at the end of the fight who dispelled 'Vampiric Might' from adds"
    psicctxtbysaved = "Quantity of combats saved: "
    psiccticks = "ticks (sec)"
    psiccsindraaddontxt =
        "Addon shows Ice Tomb's HP on Air phase in unique frame, frame of your target blinks, frame of your mouseover target - gets red background"
    ...
    psficcsaurtxtset5 =
        "announce in raid chat force-majeur situations (important!)"
    ...
    psiccbossfail104 =
        "Announce after 30 sec after fight begun, if there is no 'Amplify Magic'"
    psiccbossfail104t = "Valithria Dreamwalker > there is no:"
    psiccresetliststxt = "Reset lists"
    psiccbossfail105 =
        "Announce at the end of the fight who used bandages to heal boss"
    psiccbossfail105t = "Best healers that used bandages: "
    psiccbossfail118 =
        "Announce at the end of the fight who got more debuffs 'Unchained Magic' then others"
    psiccbossfail118t = "Losers (top of Unchained Magic debuffs): "
    psiccbossfail129 =
        "Announce during the fight who made damage to Val'kyr under 51% HP (25 heroic only)"
